...
function Reportproblem() {
    useEffect(()=>{
      ...
      <p>
      if you find any errors in the writings or any bug in the App design you can send us an email @<span style={{color:'blue'}}>bhagyalakshmiinala80@gmail.com </span>
